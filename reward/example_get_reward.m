...
% Выполняется моделирование на модели.
simOut = sim("power_KundurTwoAreaSystem.slx");

% Расчет награды и её изменения во времени
[reward, reward_list] = get_reward1('IntGamma', false, Ts, 20, inertia_consts, D, W, 1.0e+06);
...
%                    из-за ошибки
%
function [reward, reward_list] = get_reward1(reward_type, time_gain, time_step, simStopTime, inertia_consts, delta_matrix, w_matrix, penalty)
