function events = prepareEvents_1phSCg_A_3ph_line(model,config, rp_type)
...
events(6).EventDescription = "Событие: \n" + ...
                             "1фКЗ ф.А в середине ВЛ-1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 1ф КЗ в середине ВЛ1
events(6).KZ_Lm.Times  = [dist_moment, dist_moment + t_breaking];
events(6).KZ_Lm.PhaseA = 'on';
events(6).KZ_Lm.PhaseB = 'off';
...
events(7).EventDescription = "Событие: \n" + ...
                             "1фКЗ ф.А в конце ВЛ-1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 1ф КЗ в конце ВЛ1
events(7).KZ_Le.Times  = [dist_moment, dist_moment + t_breaking];
events(7).KZ_Le.PhaseA = 'on';
events(7).KZ_Le.PhaseB = 'off';
