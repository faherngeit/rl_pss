function events = prepareEvents_2phSCg_gen(model, config)
...
events(1).EventDescription = "Событие: \n" + ...
                             "2фКЗ на землю ф.АB на НН Г1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф на землю КЗ на НН Г1
...
events(2).EventDescription = "Событие: \n" + ...
                             "2фКЗ на землю  ф.АB на НН Г2. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г2
...
events(3).EventDescription = "Событие: \n" + ...
                             "2фКЗ на землю ф.АB на НН Г3. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г3
...
events(4).EventDescription = "Событие: \n" + ...
                             "2фКЗ на землю  ф.АB на НН Г4. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г4
