function events = prepareEvents_2phSC_AB_line(model,config, rp_type)
...
events(1).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB на ВН Г1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ на ВН Г1
...
events(1).KZ_A1_G1_HV.PhaseG = 'off';

% Описание события
events(2).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB на ВН Г2. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ на ВН Г2
...
events(2).KZ_A1_G2_HV.PhaseG = 'off';

% Описание события
events(3).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB на ВН Г3. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ на ВН Г3
...
events(3).KZ_A2_G3_HV.PhaseG = 'off';

% Описание события
events(4).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB на ВН Г4. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ на ВН Г4
...
events(4).KZ_A2_G4_HV.PhaseG = 'off';

% Описание события
events(5).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB в начале ВЛ-1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ в начале ВЛ1
...
events(6).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB в середине ВЛ-1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
...
events(7).EventDescription = "Событие: \n" + ...
                             "2фКЗ ф.АB в конце ВЛ-1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 2ф КЗ в конце ВЛ1
