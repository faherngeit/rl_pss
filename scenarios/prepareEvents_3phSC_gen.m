function events = prepareEvents_3phSC_gen(model, config)
...
events(1).EventDescription = "Событие: \n" + ...
                             "3фКЗ на НН Г1. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г1
...
events(1).KZ_A1_G1_LV.PhaseC = 'on';
events(1).KZ_A1_G1_LV.PhaseG = 'on';

% Описание события
events(2).EventDescription = "Событие: \n" + ...
                             "3фКЗ на НН Г2. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г2
...
events(2).KZ_A1_G2_LV.PhaseC = 'on';
events(2).KZ_A1_G2_LV.PhaseG = 'on';

% Описание события
events(3).EventDescription = "Событие: \n" + ...
                             "3фКЗ на НН Г3. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г3
...
events(3).KZ_A2_G3_LV.PhaseC = 'on';
events(3).KZ_A2_G3_LV.PhaseG = 'on';

% Описание события
events(4).EventDescription = "Событие: \n" + ...
                             "3фКЗ на НН Г4. T_кз = " + dist_moment + " с, " + "T_откл = " + t_breaking + " с, \n";
% 3ф КЗ на НН Г4
...
events(4).KZ_A2_G4_LV.PhaseC = 'on';
events(4).KZ_A2_G4_LV.PhaseG = 'on';
