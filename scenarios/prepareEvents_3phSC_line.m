function events = prepareEvents_3phSC_line(model, config, rp_type)
...
events(1).KZ_A1_G1_HV.PhaseC = 'on';
...
events(2).KZ_A1_G2_HV.PhaseC = 'on';
...
events(3).KZ_A2_G3_HV.PhaseC = 'on';
...
events(4).KZ_A2_G4_HV.PhaseC = 'on';
